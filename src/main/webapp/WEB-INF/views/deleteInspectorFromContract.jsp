...
<head>
    ...
    <title>Usuwanie Inspektorów</title>
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Usuń Instruktorów</h1>
                        </div>
                        <form:form method="post" modelAttribute="contract">
                            ...
                            <form:hidden path="inspectorList" itemValue="id" itemLabel="fullName" items="${contractInspectorList}" multiple="true"/><br>
                            ...
                            <select name="inspectorToDelete" multiple>

                                <c:forEach var="inspector" items="${contractInspectorList}">

...
<head>
    ...
    <title>Widok dodawania roli</title>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Lista Inspektorów</h1>
                </div>
                    ...
                    <table cellspacing="0" cellpadding="0" border="1" style="width: 100%;">
                        ...
                        <c:forEach items="${inspectors}" var="inspector">
                            <tr>
                                ...
                                <td>
                                    <a href="/contractAdmin/addRole?id=${inspector.id}" class="btn btn-danger rounded-0 text-light m-1">Dodaj rolę</a>
                                    <a href="/contractAdmin/deleteRoleView/${inspector.id}/${inspector.fullName}" class="btn btn-danger rounded-0 text-light m-1">Usuń rolę</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>

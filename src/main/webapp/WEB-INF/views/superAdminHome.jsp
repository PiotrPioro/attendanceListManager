...
<head>
    ...
    <title>Super Admin strona główna</title>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Lista wszystkich kontraktów</h1>
                </div>
                ...
                <div class="row">
                    ...
                    <table cellspacing="0" cellpadding="0" border="1" style="width: 100%;">
                        ...
                        <h5><a href="/calendar/minusAdminMonth?monthValue=${monthValue}&year=${year}"><-   </a> ${month} ${year}<a href="/calendar/plusAdminMonth?monthValue=${monthValue}&year=${year}">    -></a></h5>
                        <thead>
                        <tr>
                            <th>Poniedziałek</th>
                            <th>Wtorek</th>

                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Dodaj szczegóły kontraktu</h1>
                        </div>
                        <form:form method="post" modelAttribute="contractDetails">

                            <form:hidden path="id"/>

                            <form:hidden path="inspectorId" value="${inspectorId}"/><br>
